...
Наш каталог построен и по мнемоническому принципу. Так код 111 можно читать 
как "самый первый", 222 — всегда второй, 342 — ответ на все вопросы, х99 — идет 
последним. Посмотрите на рецепты и вы создадите свои смыслы почти для каждого номера.

Главное практическое преимущество этой системы — правильный порядок приготовления растворов. 
Просто следуйте возрастанию номеров в рецепте! Кстати, не все авторы располагают ингредиенты 
в порядке их смешивания, а нарушение последовательности часто бывает фатальным. 
...
включите его в соответствующую категорию с новым номером. Конечно будет хорошо 
просмотреть справочники и рекомендации перед тем как присвоить номер в группе. Немного
времени на поиск, но зато потом вы гарантировано никогда не запутаетесь.

Система упрощает поиск веществ — первая цифра сразу указывает на тип вещества и 
секцию хранения. В международной среде числовой код эффективно преодолевает 
языковые барьеры. Сравните: сказать англоговорящему коллеге «Wersenian sodu 2hydrat» 
или попросить химикат №499 — что будет понятнее? То же верно и наоборот: «EDTA 
Disodium» может вызвать затруднения у неанглоязычного химика. Найти реактив по 
номеру не только понятнее, но и быстрее.

Особую ценность числовая кодировка представляет в инклюзивной среде, в частности, 
для людей, использующих жестовые языки. В мире существует около 150 различных 
жестовых языков (ASL, BSL, LSF и многие другие), и, несмотря на различия в 
обозначении понятий, числовые жесты обычно более универсальны и легче осваиваются. 
Талантливые фотографы с нарушениями слуха, такие как Джейми Дель Пиццо 
(Jaime Del Pizzo) или Лили Бертран-Уэбб (Lily Bertrand-Webb), своим творчеством 
демонстрируют, что искусство аналоговой фотографии доступно каждому, а подобные 
системы кодирования делают работу в лаборатории еще более доступной. Их опыт 
показывает, как важно создавать универсальные системы коммуникации, особенно 
в технической среде.
...
Система кодировки специально создана для фотолаборатории. Кодировка реактивов и категорий хранения 
